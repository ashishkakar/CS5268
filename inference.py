...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        if noisyDistance is None and jailPosition==ghostPosition:
            return 1.0
        elif jailPosition==ghostPosition and noisyDistance is not None:
            return 0.0
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for ghostP in self.allPositions:
            self.beliefs[ghostP] *= self.getObservationProb(observation, gameState.getPacmanPosition(), ghostP, self.getJailPosition())
        self.beliefs.normalize()
        #raiseNotDefined()
    ...
    def elapseTime(self, gameState):
        ...
        for p in self.allPositions:
            ...
            for p2 in dist:
                temp[p2] += dist[p2] * self.beliefs[p]
        self.beliefs = temp
        self.beliefs.normalize()
        #raiseNotDefined()
